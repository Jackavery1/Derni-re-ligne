...
test(
    'cutscene paysage mobile — boutons dans la zone visible',
...
test(
    'cutscene ultra-etroit 319px — pas de debordement',
...
test(
    'cutscene ultra-etroit 319px — portraits visibles sans debordement (audit D8)',
    { tag: '@viewport-mobile-etroit' },
    async ({ page }) => {
