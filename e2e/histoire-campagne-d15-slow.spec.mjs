...
/** Parcours complet 16 mondes — nightly uniquement (exclu de test:e2e:audit via fichier dédié). */
test(
    'campagne — cutscenes intermediaires boss et chapitres (audit D15) @slow',
    { tag: '@slow' },
    async ({ page }) => {
