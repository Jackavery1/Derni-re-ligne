...
writeFileSync('js/codex/codex-conditions.js', genererFichierConditions(conditionsSrc));
...
console.log(
    `Codex exporté → data/codex-textes.json (${Object.keys(textes).length} entrées), js/codex/codex-conditions.js`
);
