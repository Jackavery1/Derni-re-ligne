...
Inclus : `migrer-js-domaines.mjs`, `migrer-js-transverses.mjs`, `migrer-js-racine-vague3.mjs`, `corriger-imports-js.mjs` (migration physique `js/<domaine>/`), `migrer-imports-config.mjs` (barrel `config.js` → imports directs).
