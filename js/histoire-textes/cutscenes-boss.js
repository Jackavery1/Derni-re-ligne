export const CUTSCENES_VICTOIRE_BOSS = {
    brasier: [
        ...
        { personnage: 'robo', texte: '...', humeur: 'triste' },
        {
            personnage: 'robo',
    ...
    sentinelle: [
        { personnage: 'sentinelle', texte: 'Tu... bouges encore.', humeur: 'vacillant' },
    ...
    distorsion_normal: [
        ...
        {
            personnage: 'robo',
            texte: "Je suis désolé. Je n'ai pas su faire autrement.",
            humeur: 'neutre',
        },
        {
            personnage: 'distorsion',
            texte: "Je sais. C'est pour ça que je ne t'en veux pas.",
            humeur: 'souffrante',
        },
        {
            personnage: 'distorsion',
        ...
        {
            personnage: 'vera',
            texte: "Non. J'ai juste cru en toi. C'est différent.",
            humeur: 'neutre',
        },
    ],
    ...
    distorsion_vrai: [
        ...
        {
            personnage: 'robo',
            texte: "Non. C'est de la place pour quelque chose de nouveau.",
            humeur: 'neutre',
        },
        {
            personnage: 'vera',
    ...
    distorsion_secret: [
        {
            personnage: 'robo',
            texte: "J'ai trouvé ta ligne. Celle du centre. La toute première.",
            humeur: 'neutre',
        },
        {
            personnage: 'distorsion',
            texte: "VERA l'a laissée incomplète exprès. Pour m'étudier.",
            humeur: 'souffrante',
        },
        ...
        {
            personnage: 'robo',
            texte: 'Complétons-la. Ensemble. Toi, moi. Et elle.',
            humeur: 'neutre',
        },
        {
            personnage: 'narrateur',
        ...
        { personnage: 'robo', texte: '« Mon amie » ? Laquelle de nous deux ?', humeur: 'neutre' },
        {
            personnage: 'vera',
...
export const CUTSCENES_POST_MONDE = {
    monde_prologue: [
        ...
        {
            personnage: 'robo',
            texte: "Ce qui l'est moins : pourquoi est-ce que ça me satisfait ?",
            humeur: 'excite',
        },
        {
            personnage: 'robo',
    ...
    monde_lave: [
        {
            personnage: 'robo',
            texte: "Je m'attendais à quelque chose de plus complexe.",
            humeur: 'neutre',
        },
        {
            personnage: 'robo',
    ...
    monde_ocean: [
        {
            personnage: 'robo',
            texte: "Sous l'eau, les sons voyagent différemment.",
            humeur: 'neutre',
        },
        {
            personnage: 'robo',
        ...
        { personnage: 'robo', texte: 'Une question. Sans mots.', humeur: 'neutre' },
        {
            personnage: 'robo',
            texte: "Je pense que c'était elle.",
            humeur: 'triste',
        },
        {
            personnage: 'robo',
    ...
    monde_glace: [
        ...
        {
            personnage: 'robo',
            texte: "Je n'aime pas ne pas savoir laquelle des deux.",
            humeur: 'neutre',
        },
    ],
    ...
    monde_eclipse: [
        {
            personnage: 'robo',
            texte: "Ce monde m'a appris quelque chose d'utile.",
            humeur: 'neutre',
        },
        {
            personnage: 'robo',
    ...
    monde_fuochi: [
        {
            personnage: 'robo',
            texte: "Les feux d'artifice n'ont pas de raison d'être beaux.",
            humeur: 'content',
        },
        { personnage: 'robo', texte: 'Et pourtant ils le sont.', humeur: 'excite' },
        {
            personnage: 'robo',
        ...
        {
            personnage: 'robo',
            texte: "Je commence à comprendre ce qu'elle voulait dire.",
            humeur: 'neutre',
        },
    ],
    ...
    monde_miroir: [
        {
            personnage: 'robo',
            texte: "J'ai joué à l'envers. Gravité inversée, couleurs fausses.",
            humeur: 'alerte',
        },
        {
            personnage: 'robo',
