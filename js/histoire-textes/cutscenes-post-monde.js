export const CUTSCENES_POST_MONDE = {
    monde_prologue: {
        ...
        lignes: [
            {
                personnage: 'robo',
                texte: 'Les blocs répondent à mes commandes.',
                humeur: 'content',
            },
            {
                personnage: 'robo',
    ...
    monde_foret: {
        ...
        lignes: [
            {
                personnage: 'narrateur',
                texte: 'Dans la Forêt, rien ne se perd. Tout se transforme.',
            },
            {
                personnage: 'robo',
    ...
    monde_eclipse: {
        ...
        lignes: [
            ...
            {
                personnage: 'robo',
                texte: '— joue comme si les deux étaient vraies.',
                humeur: 'triste',
            },
        ],
    },
    ...
    monde_paradoxe: {
        ...
        lignes: [
            ...
            {
                personnage: 'robo',
                texte: "J'ai laissé une ligne incomplète. Volontairement.",
                humeur: 'neutre',
            },
            {
                personnage: 'vera',
                texte: 'Tu as appris à lire entre les blocs.',
                humeur: 'douce',
            },
        ],
    },
