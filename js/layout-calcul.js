 ...
 * @param {{ margeScale?: number, hauteurControles?: number, scaleMax?: number }} [opts]
 */
export function calculerEchelleInterface(
    ...
    const { margeScale = 20, hauteurControles = 0, scaleMax = 2.2 } = opts;
    ...
    return Math.min(scaleW, scaleH, scaleMax);
}
